...
using CBPlatformTest.Core.Effects;
using CBPlatformTest.Core.Localization;
using CBPlatformTest.Core.Settings;
using CBPlatformTest.ScreenManagers;
using CBPlatformTest.Screens;
using Microsoft.Xna.Framework;
using Microsoft.Xna.Framework.Graphics;

namespace CBPlatformTest.Core
{
    /// <summary>
    ...
    /// </remarks>}
    public class CBPlatformTestGame : Game
    {
        ...
        private SettingsManager<CBPlatformTestSettings> settingsManager;

        // Manages leaderboard data for tracking high scores and achievements.
        private SettingsManager<CBPlatformTestLeaderboard> leaderboardManager;
        ...
        public CBPlatformTestGame()
        {
            ...
            settingsManager = new SettingsManager<CBPlatformTestSettings>(storage);
            Services.AddService(typeof(SettingsManager<CBPlatformTestSettings>), settingsManager);

            leaderboardManager = new SettingsManager<CBPlatformTestLeaderboard>(storage);
            Services.AddService(typeof(SettingsManager<CBPlatformTestLeaderboard>), leaderboardManager);
